...
To contribute to kubernetes-101 project on [GitHub](https://github.com/luismayta/kubernetes-101), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/kubernetes-101/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to kubernetes-101 project on Gitlab:
...
```bash
git remote add upstream  https://github.com/luismayta/kubernetes-101.git
```

Now your **upstream** points to **luismayta/kubernetes-101**.
...
git fetch upstream # assuming upstream is rfid/kubernetes-101
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/kubernetes-101/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
